...
const Main = observer(() =>  {
    ...
    useEffect(() => {
        let url_get_new = MyLink.API_URL_GET_NEW_GAME + '/' + 0
        let url_get_popular = MyLink.API_URL_GET_POPULAR_GAME + '/' + 0
        let url_get_popular_count = MyLink.API_URL_GET_POPULAR_GAME_COUNT
        ...
        fetch( url_get_popular, {
            method: 'GET'
        }).then( data => data.json())
            .then( data => {
                popular.setGames(data)
            }).catch( (error) =>{
            console.log(error)
            alert(error)
        });

        fetch( url_get_popular_count, {
            method: 'GET'
        }).then( data => data.json())
            .then( data => {
                popular.setTotal(data)
            console.log(data)
            }).catch( (error) =>{
            console.log(error)
            alert(error)
    ...
    useEffect(()=> {
        let url_get_popular = MyLink.API_URL_GET_POPULAR_GAME + '/' + popular.page
    ...
    useEffect(()=>{
        ...
        let url_get_new = MyLink.API_URL_GET_NEW_GAME + '/' + game.page
        fetch( url_get_new, {
            method: 'GET'
        }).then( data => data.json())
            .then( data => {
    ...
    function changePagePlus(){
        ...
        setTimeout(() => {
            if(popular.countTotal <= (popular.page * 4)){
